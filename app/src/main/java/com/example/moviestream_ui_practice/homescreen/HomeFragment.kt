...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        view.movieStreamViewPager.adapter = HomeImageAdapter(requireActivity().supportFragmentManager, lifecycle, imageList)
    ...
    private fun setView(view: View, isActive: Boolean) {
        if (isActive) {
            ...
            widthAnimator.duration  = Constant.TWOHUNDRED
